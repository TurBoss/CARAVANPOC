...
class BackgroundPanel(rompanel.ROMPanel):
    ...
    def init(self):
        ...
        self.editPanel = rompanel.SpritePanel(self, wx.ID_ANY, 32*8, 12*8, self.palette, scale=2, bg=16) #, func="edit")
    ...
    def refreshPixels(self):
        ...
        #self.charList.Append(`len(self.background.raw_bytes)`)
    ...
    def OnSelectBackground(self, evt):
        self.changeBackground(evt.GetSelection())
