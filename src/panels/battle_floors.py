...
class BattleFloorPanel(rompanel.ROMPanel):
    ...
    def init(self):
        ...
        self.editPanel = rompanel.SpritePanel(self, wx.ID_ANY, 12*8, 4*8, self.palette, scale=5, bg=16) #, func="edit")
    ...
    def refreshPixels(self):
        ...
        #self.charList.Append(`len(self.battleFloor.raw_bytes)`)
    ...
    def OnSelectBattleFloor(self, evt):
        self.changeBattleFloor(evt.GetSelection())
