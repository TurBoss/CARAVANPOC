...
class OtherIconPanel(rompanel.ROMPanel):
    ...
    def init(self):
        ...
        #inst = wx.StaticText(self, -1, "Edit other icon graphics.")
        #inst.Wrap(inst.GetClientSize()[0])
        
        leftSizer = wx.BoxSizer(wx.VERTICAL)
        
        #sbs1 = wx.StaticBoxSizer(wx.StaticBox(self, -1, "1. Select an icon."), wx.VERTICAL)
        #sbs2 = wx.StaticBoxSizer(wx.StaticBox(self, -1, "Items/spells using this icon"), wx.VERTICAL)
        ...
        self.iconList.AppendItems([self.rom.data["other_icons"][s].name for s in range(len(self.rom.data["other_icons"]))]) #, "u2", "yay")
        ...
        #self.otherList = wx.ListBox(self, wx.ID_ANY, size=(200,40))
        #sbs2.Add(self.otherList, 1, wx.ALL, 10)
        ...
        self.editPanel = rompanel.SpritePanel(self, wx.ID_ANY, 16, 24, self.palette, scale=8, bg=16, func="edit")
        self.editPanel
        ...
        """self.animPanel = rompanel.SpritePanel(self, wx.ID_ANY, 16, 24, self.palette, scale=3, bg=None, edit=False)
        #self.animPanel.buffer = wx.EmptyBitmap(*self.animPanel.GetSize())
        #self.animPanel.refreshSprite(self.rom.data["other_icons"][0].pixels
    ...
    def refreshPixels(self):
        ...
        #self.otherList.Append(`len(self.icon.raw_bytes)`)
        #self.otherList.Append(`len(h)`)
